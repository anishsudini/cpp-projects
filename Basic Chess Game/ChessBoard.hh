...
namespace Player
{
    ...
    public:
         ...
         * If there is already a piece at the given position, it will be replaced.
         * @param piece
         * The piece to be set at the specified position.
         * @param row
         * The row at which the piece should be placed.
         * @param column
         * The column at which the piece should be placed.
         */
        void setPiece(ChessPiece* piece, int row, int column);
